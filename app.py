"""
Abonmarche Plan Review - Internal Tool
Simple web interface for civil engineering planset QA/QC review
...
def review_planset():
    ...
    try:
        ...
        if checklist_id:
            ...
            if checklist:
                logger.info(f"Loaded checklist: {checklist_id} with {len(checklist.get('items', []))} items")
        ...
        checklists = {
            '30_percent': {
                ...
                'items': [
                    ...
                    {'id': '30-GEN-003', 'text': 'North arrow shown correctly', 'required': True},
                    {'id': '30-GEN-004', 'text': 'Scale shown correctly', 'required': True},
            ...
            '60_percent': {
                ...
                'items': [
                    ...
                    {'id': '60-GEN-003', 'text': 'Cross sections reviewed', 'required': True},
